...
1. **Node.js** – Download the LTS (Long Term Support) version from [nodejs.org](https://nodejs.org)  
   - This will be our main runtime environment for JavaScript

2. **Postman** – Download from [postman.com/downloads](https://postman.com/downloads)  
...
Once you have these installed, we’ll be ready to start building amazing things together!  
